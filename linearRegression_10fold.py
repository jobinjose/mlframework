...
while chunk_split_start_loop_size <= data.shape[0]:
    ...
    print("RMSE on 10 fold for chunk size ",chunk_split_start_loop_size,": %.2f" %rmse_10cv)
    print("R2 on 10 fold for chunk size ",chunk_split_start_loop_size,": %.2f" %(sum(R2)/n_splits))
